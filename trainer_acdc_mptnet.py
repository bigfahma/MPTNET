...
from monai.transforms import AsDiscrete, Activations, Compose, EnsureType, KeepLargestConnectedComponent
...
class MPTNET_ACDC(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        outputs = sliding_window_inference(inputs,  (8, 128, 128), 1, self.model, overlap=0.5)
    ...
    def on_validation_epoch_end(self):
        ...
        mean_val_dice = (mean_dice_c1 + mean_dice_c2 + mean_dice_c3) / 3
    ...
    def on_test_epoch_end(self):
        ...
        print(f'Mean Test Dice score : {mean_test_dice}. \n Test dice score per class : C1 : {mean_dice_c1}, C2: {mean_dice_c2}, C3: {mean_dice_c3}')
